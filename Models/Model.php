...
abstract class Model
{
    ...
    {
        //retourne le nom de  la model 
        //si ou la function static on a utilisant la method get_called_class()
    ...
    // se function exucuter pour l'ajout ou modification
    //si ou id ==0 alors la methode exucute si l'ajout
    //si ou id !=0 alors la methode exucute si modification
